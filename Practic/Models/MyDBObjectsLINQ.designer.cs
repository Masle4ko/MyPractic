...
namespace MyBlog.Models
{
    ...
    partial void OnGeoLatChanging(string value);
    partial void OnGeoLatChanged();
    partial void OnGeoLongChanging(string value);
    partial void OnGeoLongChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_StartDate", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EndDate", CanBeNull=false)]
	...
	public partial class UserProfile : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<webpages_UsersInRoles> _webpages_UsersInRoles;
    ...
    partial void OnUserNameChanged();
		...
		{
			this._Comment = new EntitySet<Comment>(new Action<Comment>(this.attach_Comment), new Action<Comment>(this.detach_Comment));
			this._webpages_UsersInRoles = default(EntityRef<webpages_UsersInRoles>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="UserProfile_webpages_UsersInRoles", Storage="_webpages_UsersInRoles", ThisKey="UserId", OtherKey="UserId", IsUnique=true, IsForeignKey=false)]
		public webpages_UsersInRoles webpages_UsersInRoles
		{
			get
			{
				return this._webpages_UsersInRoles.Entity;
			}
			set
			{
				webpages_UsersInRoles previousValue = this._webpages_UsersInRoles.Entity;
				if (((previousValue != value) 
							|| (this._webpages_UsersInRoles.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._webpages_UsersInRoles.Entity = null;
						previousValue.UserProfile = null;
					}
					this._webpages_UsersInRoles.Entity = value;
					if ((value != null))
					{
						value.UserProfile = this;
					}
					this.SendPropertyChanged("webpages_UsersInRoles");
				}
			}
		}
    ...
    partial void OnRoleNameChanged();
		...
		public int RoleId
		{
			...
			set
			{
				...
				{
					if (this._webpages_UsersInRoles.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="webpages_UsersInRoles_webpages_Roles", Storage="_webpages_UsersInRoles", ThisKey="RoleId", OtherKey="UserId", IsForeignKey=true)]
		public webpages_UsersInRoles webpages_UsersInRoles
		{
			get
			{
			...
			set
			{
							...
							|| (this._webpages_UsersInRoles.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._webpages_UsersInRoles.Entity = null;
						previousValue.webpages_Roles = null;
					}
					this._webpages_UsersInRoles.Entity = value;
					if ((value != null))
					{
						value.webpages_Roles = this;
    ...
    partial void OnRoleIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="webpages_UsersInRoles_webpages_Roles", Storage="_webpages_Roles", ThisKey="UserId", OtherKey="RoleId", IsUnique=true, IsForeignKey=false)]
			...
			set
			{
							...
							|| (this._webpages_Roles.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.webpages_UsersInRoles = null;
					}
					this._webpages_Roles.Entity = value;
					if ((value != null))
					{
						value.webpages_UsersInRoles = this;
					}
