...
namespace MyBlog.Models
{
    public class DataManager
    {
        ...
        */
        ...
        private CalendarContext _calendarrepository;
        public CalendarContext calendar
        {
            get
            {
                if (_calendarrepository == null)
                    _calendarrepository = new CalendarContext(_datacontext);
        ...
        //private MapContext _maprepository;
        //public MapContext mapRep
        //{
        //    get
        //    {
        //        if (_maprepository == null)
        //            _maprepository = new MapContext(_datacontext);
